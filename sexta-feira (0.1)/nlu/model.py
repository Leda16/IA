...
# Criar o dataset one-hot (numeros de exemplos, tamanho da seq, numero de caracteres)
# Criar o dataset disperso (numeros de exemplos, tamanho da seq)
